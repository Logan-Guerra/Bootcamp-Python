...
tyler = User("tyler", "tyler@python.com", "2/12/2000", "Checking")
jack = User("jack Matt", "jack@python.com", "9/6/1990", "Checking", .01, 0)
Logan = User("Logan Guerra", "loganrguerra@python.com", "6/26/1996", "Checking", .01, 1000)
logan_savings = User("Logan Guerra", "loganrguerra@python.com", "6/26/1996", "Savings", .8, 0)


tyler.make_deposit(500, "Checking").make_deposit(200, "Checking").make_deposit(1000, "Checking").make_withdrawal(300, "Checking") # .display_user_balance("Checking")
jack.make_deposit(1000, "Checking").make_deposit(1500, "Checking").make_withdrawal(500, "Checking").make_withdrawal(200, "Checking").make_withdrawal(300, "Checking").make_withdrawal(100, "Checking") # .display_user_balance("Checking")
logan_savings.make_deposit(500, "Savings") 

print(Logan.transfer_money(jack, "Savings", 500, "Checking"))
